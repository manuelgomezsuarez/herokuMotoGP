...
from app.views import PosicionCarreraViewSet,PosicionCampeonatoViewSet,PosicionDocumentacionViewSet,index,PilotoViewSet
...
merouter.register(r'piloto', PilotoViewSet,base_name="piloto")
